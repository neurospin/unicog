function physio_regressors_computation_tapas_7T_diff_dir(data_local_dir, physio_dir, root_file_name, c, r, cr, verbose_level)
%
...
log_files.vendor            = 'siemens_ns_7t_bis';
...
model.output_multiple_regressors = fullfile(data_local_dir, strcat('physio_regressors_', root_file_name, '.txt'));
