...
if hasFirstGuessPeaks
    ...
    if debug
        ...
        %% Added by A. Moreno - 04/07/2016
        % To improve figures visualization
        hp(3) = plot(t, c, 'k', 'LineWidth', linewidth);
        ...
        %% Added by A. Moreno - 04/07/2016
        % To improve figures visualization
        plot(t(cpulse1stGuess(2:end)), diff(t(cpulse1stGuess)), 'LineWidth', linewidth);    

        hold all
        %plot(t(cpulse2ndGuess(2:end)), diff(t(cpulse2ndGuess)));
        %% Added by A. Moreno - 04/07/2016
        % To improve figures visualization
        plot(t(cpulse2ndGuess(2:end)), diff(t(cpulse2ndGuess)), 'LineWidth', linewidth);
    ...
    if debug
        ...
        %% Added by A. Moreno - 04/07/2016
        % To improve figures visualization
        plot(t, c, 'k', 'LineWidth', linewidth); title('Finding first peak of cycle, backwards')
...
if debug
    ...
    %% Added by A. Moreno - 04/07/2016
    % To improve figures visualization
    plot(tTemplate, template', 'LineWidth', linewidth);
...
if debug
    ...
    %title(stringTitle);
    %% To remplace suptitle (in a toolbox?) - A. Moreno 02/08/2016
    % adapted from: 
    % https://fr.mathworks.com/matlabcentral/answers/130782-how-do-i-use-suptitle-in-my-subplot
    
    % - Build title axes and title.
    axes( 'Position', [0, 0.95, 1, 0.1] ) ;
    set( gca, 'Color', 'None', 'XColor', 'None', 'YColor', 'None' ) ;
    text( 0.5, 0, stringTitle, 'FontSize', titlefontsize, 'FontWeight', 'Bold', ...
