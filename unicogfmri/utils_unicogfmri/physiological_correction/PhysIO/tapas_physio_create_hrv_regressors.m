...
if verbose.level>=2
    ...
    plot(sample_points,hr,'r','LineWidth',linewidth);xlabel('time (seconds)');
    title('Heart Rate');
...
if verbose.level>=2
    ...
    %% Changed by A. Moreno - 23/07/2016
    plot(t, crf,'r','LineWidth',linewidth);xlabel('time (seconds)');
...
if verbose.level>=2
    ...
    %% Changed by A. Moreno - 23/07/2016
    plot(sample_points, convHRV,'r','LineWidth',linewidth);xlabel('time (seconds)');
...
if verbose.level>=2
    ...
    %% Changed by A. Moreno - 23/07/2016
    hp{1} = plot(samplePointsOut, hrOut,'k--','LineWidth',linewidth); hold all;
    hp{2} = plot(samplePointsOut, squeeze(convHRVOut(:,iShiftMin,:)),'r','LineWidth',linewidth);
