...
if ~isempty(log_files.cardiac)
    ...
    if DEBUG
        ...
        plot(c_t, c_channel_1, 'LineWidth', linewidth);
        plot(c_t, c_channel_AVF, 'LineWidth', linewidth);
        plot(c_t, c_meanChannel, 'LineWidth', linewidth);
...
if ~isempty(log_files.respiration)
    ...
    if DEBUG
        ...
        plot(r_t, r_channel_1, 'LineWidth', linewidth);
        plot(r_t, r_channel_AVF, 'LineWidth', linewidth);
        plot(r_t, r_meanChannel, 'LineWidth', linewidth);
