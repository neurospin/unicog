...
if nargin < 6
    methodPeakDetection = 'correlation'; %'matched_filter', 'xcorr', or 'correlation' % --> 1/2 peaks detected
    %methodPeakDetection = 'matched_filter'; % --> 1/2 peaks detected and a bit shifted
    %methodPeakDetection = 'xcorr';
end
