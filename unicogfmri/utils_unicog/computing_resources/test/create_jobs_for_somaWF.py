...
subjects_dir = "/neurospin/unicog/protocols/IRMf/Unicogfmri/Base_FS"
path_script = "/neurospin/unicog/protocols/IRMf/Unicogfmri/test_SomaWF"
...
def create_shell_file(id_subject):
    anat = "{subjects_dir}/{id_subject}/mri/orig/001.mgz".format(
                    subjects_dir=subjects_dir, id_subject=id_subject)
    output = "{subjects_dir}/{id_subject}/mri/orig/001.nii".format(
                    subjects_dir=subjects_dir, id_subject=id_subject)
