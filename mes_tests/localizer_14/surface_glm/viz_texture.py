...
def show_contrasts(subject, contrasts, side, threshold):
    ...
    title = subject + '_on_template_FSAVERAGE_surfacique_video-audio'
    mlab.title(title)
    
    
    #add texture
    text_file = "/neurospin/unicog/protocols/IRMf/Tests_Isa/Test_surface_glm/data/surface_glm/subject01/video-audio_z_map_lh.gii"
    #text_file = "/neurospin/unicog/protocols/IRMf/Tests_Isa/Test_surface_glm/data/surface_glm/subject01/computation_z_map_lh.gii"

#    #print curv_file
#    text = (read_morph_data(curv_file) < 0).astype(int)
#    
